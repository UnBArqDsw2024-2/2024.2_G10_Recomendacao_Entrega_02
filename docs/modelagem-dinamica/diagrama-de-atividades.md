...
## Metodologia
O Diagrama de Atividades foi desenvolvido na plataforma LucidChart, uma ferramenta de criação de diagramas que permite aos usuários trabalharem juntos simultaneamente no mesmo documento.
